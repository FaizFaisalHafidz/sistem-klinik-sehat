...
<body>
    ...
    <div class="stats">
        <div class="stat-item">
            <h3>{{ $stats['total_pasien'] ?? 0 }}</h3>
            <p>Total Pasien</p>
        </div>
        <div class="stat-item">
            <h3>{{ $stats['pasien_laki'] ?? 0 }}</h3>
            <p>Laki-laki</p>
        </div>
        <div class="stat-item">
            <h3>{{ $stats['pasien_perempuan'] ?? 0 }}</h3>
            <p>Perempuan</p>
        </div>
        <div class="stat-item">
    ...
    <table>
        <thead>
            <tr>
                <th style="width: 15%">Kode Pasien</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $item->umur ?? 'N/A' }}</td>
                <td>{{ $item->telepon ?: 'Tidak ada' }}</td>
            ...
            <tr>
                <td colspan="7" style="text-align: center; color: #666; font-style: italic;">
                    Tidak ada data pasien dalam periode yang dipilih
                </td>
            </tr>
            @endforelse
        </tbody>
